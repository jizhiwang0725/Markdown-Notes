...
|| Be looking to | - Means **planning** a course of action.<br> - Particularly in **speech and in journalism.** | *We're **looking to** create 3000 jobs in the city over the next year.* |
| **Past simple / continuous** | - Past tenses of phrases for<br> **predictions and intentions** | - Future events **seen from the past**. | *Nathan **had resolved to** become fluent in Spanish before he left university.* |

### Present continuous
- **Fixed arrangement**  
  You have already taken steps to organize it, such as **setting a date, time, or buying a ticket.**  

  > *I **am flying** to Paris on Friday.*

- **Firm intention**  
  Sometimes indicates that we have a **firm intention** or have made a definite decision to do something, although this may **NOT already be arranged.**
...
| :--- | :--- | :--- | :--- |
| **Very near future** | Be about to | - Often used for **daily conversation.** | ***We're about to eat**. Do you want to join us?* |
|| Be on the verge of + (-ing/noun) | - Often describes something **negative**. | *People are **on the verge of** starvation as the drought continues.* |
|| Be on the brink of/point of + (-ing/noun) | - Usually refers to something<br> **important, exciting, or very bad**. | *Scientists are **on the brink of** making major advances in the fight against AIDS.* |
| **Near future** | Be sure / bound to | - **Certainly** that something **will** happen. | *-Will there be somewhere to get a coffee at the station?*<br> *-Oh, yes, there **is bound to** be.* |
