...
- [The Simple Aspect](#the-simple-aspect)
  - [Present simple](#present-simple)
    - [Truth or fact](#truth-or-fact)
    - [Routine or habit](#routine-or-habit)
...
- [The Perfect Continuous Aspect](#the-perfect-continuous-aspect)
  - [Present perfect continuous](#present-perfect-continuous)
    - [Looking at the past while doing](#looking-at-the-past-while-doing)
  - [Past perfect continuous](#past-perfect-continuous)
    - [Ongoing until another event in the past](#ongoing-until-another-event-in-the-past)
  - [Future perfect continuous](#future-perfect-continuous)
    - [Duration of future events](#duration-of-future-events)
...
# The Simple Aspect
- It does **NOT care how long** the action takes. It delivers the **raw data**.  
...
### Completed actions 
- **Action verbs**  
  Completed (repeated) actions at a specific time in the **past**.  
  - *Yesterday*
  - *Last [time]*
  - *In [past year]*
  - *[Time] ago*
...
- Zooms in to the **middle of the action**. It tells you that during a specific time frame, the task was, is, or will be actively occupying your attention

- Continuous is normally for action verbs with a few exceptions
...
- **In progress when something else happened.**  
  We usually don't care about the duration.  
  - *At [exact time]*
  - *While*
  - *When (as an interruption)*
  - *All day*

  > *I **was writing** the script when the server crashed*
...
- **Action verbs**  
  ...
  Sometimes to talk about something that happened **surprisingly often** 
...
- **Action verb**  
  (Repeated) action completed at some **undefined time** in the past that matters right now. 
...
- **Action verbs**  
  ...
  - *Before*
  - *By the time*
  - *Already (paired with a past event)* 

  > *I **had written** the script before the deadline was moved.* 
...
### Looking at the past while doing
- A (repeated) action **started in the past** and is still happening right now or stopped with obvious results.    
  - *For [amount of time]*
  - *Since [starting point]*
  - *Lately*
  - *All [words for time]*

  > *I **have been writing** this script for three hours.*  
